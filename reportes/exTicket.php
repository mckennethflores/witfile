...
$empresa = "ASOCIACION CIRCULO MILITAR DEL PERU";
$documento = "RUC 20505606435";
$direccion = " CUARTEL GENERAL AV. BOULEVAR S/N";
$telefono = "959001894";
$email = "contabilidad@tubazar.com.pe";
...
<table border="0" align="center" width="500px">
    ...
    <tr>
    <td colspan="2">Dirección: <?php echo  $reg2->nomdepa.' / '.$reg2->distrito.', '.$reg2->nomzona.', '.$reg2->direccionusuario; ?></td>
    </tr>
    <tr>
