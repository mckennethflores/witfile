...
{
    $.post("../ajax/detalleCliente.php?op=obtenerRecordatorios", function (r) {
        let result = JSON.parse(r);
        document.getElementById('totalRecordatorios').innerHTML = result.count;
        document.getElementById('containerMensaje').innerHTML = result.print_data;
    });
}
getNotificaciones();
