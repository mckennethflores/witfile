              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Prospectos <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"> <i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="hidden form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                         ...
                         <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Nombres:</label>
                            <input type="text" class="form-control" placeholder="Nombres" maxLength="120" name="nom_pr" id="nom_pr" required value="">
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Apellidos:</label>
                            <input type="text" class="form-control" placeholder="Apellidos" name="ape_pr" id="ape_pr" required value="">
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Dni:</label>
                            <input type="number" class="form-control" placeholder="Dni" name="dni_pr" id="dni_pr" required value="">
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Email:</label>
                          ...
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="number" maxLength="8" class="form-control" placeholder="Telefono" name="tel_pr" id="tel_pr" value="">
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Celular:</label>
                            <input type="number" class="form-control" placeholder="Celular" name="cel_pr" id="cel_pr" value="">
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
