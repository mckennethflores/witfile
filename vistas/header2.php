...
<html>
  <head>
    ...
    <title>Bazar Central del Ejercito</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-mini">Bazar</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Tu Bazar</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            <li id="mAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li id="lProductosAllStore"><a href="producto-all-store.php"><i class="fa fa-circle-o"></i> Productos de todas las tiendas</a></li>
                 <li id="lProductosAllStore"><a href="actualizar_productos_precio.php"><i class="fa fa-circle-o"></i> Actualizar productos</a></li>
              </ul>
            </li>
            ...
            <li>
              <a target="_blank" href="http://www.tubazar.com.pe/">
